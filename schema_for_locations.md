...
* We can connect a location vertex with some position vertices by an edge type "is_corner_of". We need an ordered list of edges for a location vertex because the sequence of the positions is relevant for the shape. ![two shapes](twoShapes.png)
